...
let FolderPage = class FolderPage {
    ...
    onClick() {
        console.log('test');
        const printCurrentPosition = () => (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
...
const createCapacitor = win => {
  ...
  const defaultRegisterPlugin = (pluginName, jsImplementations = {}) => {
    ...
    const loadPluginImplementation = /*#__PURE__*/function () {
      var _ref = (0,_Users_haroldfuneme_Desktop_UAndes_semestre_4_2_Proyecto_app_movil_miso_dermoapp_grupo10_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    const createPluginMethodWrapper = prop => {
      ...
      const wrapper = (...args) => {
        ...
        if (prop === 'addListener') {
          p.remove = /*#__PURE__*/(0,_Users_haroldfuneme_Desktop_UAndes_semestre_4_2_Proyecto_app_movil_miso_dermoapp_grupo10_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            return remove();
          });
        }
    ...
    const addListenerNative = (eventName, callback) => {
      ...
      const remove = /*#__PURE__*/function () {
        var _ref3 = (0,_Users_haroldfuneme_Desktop_UAndes_semestre_4_2_Proyecto_app_movil_miso_dermoapp_grupo10_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class WebPlugin {
  ...
  addListener(eventName, listenerFunc) {
    ...
    const remove = /*#__PURE__*/function () {
      var _ref5 = (0,_Users_haroldfuneme_Desktop_UAndes_semestre_4_2_Proyecto_app_movil_miso_dermoapp_grupo10_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    Object.defineProperty(p, 'remove', {
      value: function () {
        var _ref6 = (0,_Users_haroldfuneme_Desktop_UAndes_semestre_4_2_Proyecto_app_movil_miso_dermoapp_grupo10_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          console.warn(`Using addListener() without 'await' is deprecated.`);
          yield remove();
        });
  ...
  removeAllListeners() {
    ...
    return (0,_Users_haroldfuneme_Desktop_UAndes_semestre_4_2_Proyecto_app_movil_miso_dermoapp_grupo10_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.listeners = {};
...
const readBlobAsBase64 = /*#__PURE__*/function () {
  var _ref7 = (0,_Users_haroldfuneme_Desktop_UAndes_semestre_4_2_Proyecto_app_movil_miso_dermoapp_grupo10_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (blob) {
...
module.exports = "<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>{{ folder }}</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">{{ folder }}</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <div id=\"container\">\n    <strong class=\"capitalize\">{{ folder }}</strong>\n    <p *ngIf=\"position\" >Sensor:  <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"{{ url }}\">Go to Google Map</a></p>\n    <p *ngIf=\"position\" >latitude:  {{ position.coords.latitude}}</p>\n    <p *ngIf=\"position\" >longitude:  {{ position.coords.longitude}}</p>\n    <p *ngIf=\"position\" >altitude:  {{ position.coords.altitude}}</p>\n    <p *ngIf=\"position\" >accuracy:  {{ position.coords.accuracy}}</p>\n  </div>\n</ion-content>\n<ion-button (click)=\"onClick()\">\n  Test GPS\n</ion-button>\n";
